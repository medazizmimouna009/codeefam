...
class StripeController extends AbstractController
{
    ...
    public function createSessions(Request $request, StripeService $stripeService): JsonResponse
    {
        // Decode JSON request
        ...
        $offreName = $data['offre_name'] ?? 'Unknown Offer';
        $offrePrice = isset($data['offre_price']) ? (float) $data['offre_price'] : 0.00;
