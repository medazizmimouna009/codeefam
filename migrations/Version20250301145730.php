 ...
 */
final class Version20250301145730 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE achat (id_achat INT AUTO_INCREMENT NOT NULL, id_utilisateur INT DEFAULT NULL, type_achat VARCHAR(255) NOT NULL, date_achat DATETIME NOT NULL, statut VARCHAR(255) NOT NULL, idOffre INT DEFAULT NULL, idCours INT DEFAULT NULL, INDEX IDX_26A9845650EAE44 (id_utilisateur), INDEX IDX_26A98456B842C572 (idOffre), INDEX IDX_26A98456EA0ECF81 (idCours), PRIMARY KEY(id_achat)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
