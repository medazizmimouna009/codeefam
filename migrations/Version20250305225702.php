 ...
 */
final class Version20250305225702 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE achat (id_achat INT AUTO_INCREMENT NOT NULL, id_utilisateur INT DEFAULT NULL, type_achat VARCHAR(255) NOT NULL, date_achat DATETIME NOT NULL, statut VARCHAR(255) NOT NULL, amount VARCHAR(255) DEFAULT NULL, payment_id INT DEFAULT NULL, idOffre INT DEFAULT NULL, idCours INT DEFAULT NULL, INDEX IDX_26A9845650EAE44 (id_utilisateur), INDEX IDX_26A98456B842C572 (idOffre), INDEX IDX_26A98456EA0ECF81 (idCours), PRIMARY KEY(id_achat)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE categorie (id INT AUTO_INCREMENT NOT NULL, nom_categorie VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cours (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, nom_cours_id INT DEFAULT NULL, tuteur_id INT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, duree VARCHAR(255) NOT NULL, fichier VARCHAR(255) DEFAULT NULL, updated_at DATETIME NOT NULL, INDEX IDX_FDCA8C9CBCF5E72D (categorie_id), INDEX IDX_FDCA8C9CEB85BD39 (nom_cours_id), INDEX IDX_FDCA8C9C86EC68D8 (tuteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nom_cours (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, nom VARCHAR(255) NOT NULL, INDEX IDX_57321009BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE offre (id INT AUTO_INCREMENT NOT NULL, cour_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, duree VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, INDEX IDX_AF86866FB7942F03 (cour_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, nom_cours_id INT DEFAULT NULL, texte LONGTEXT NOT NULL, niveau VARCHAR(50) NOT NULL, INDEX IDX_B6F7494EEB85BD39 (nom_cours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quiz (id INT AUTO_INCREMENT NOT NULL, nom_cours_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, niveau VARCHAR(50) NOT NULL, INDEX IDX_A412FA92EB85BD39 (nom_cours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE quiz_result (id INT AUTO_INCREMENT NOT NULL, quiz_id INT NOT NULL, user_id INT NOT NULL, score INT NOT NULL, total_questions INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', passed TINYINT(1) NOT NULL, INDEX IDX_FE2E314A853CD175 (quiz_id), INDEX IDX_FE2E314AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE video (id INT AUTO_INCREMENT NOT NULL, cours_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, video_name VARCHAR(255) DEFAULT NULL, video_file VARCHAR(255) DEFAULT NULL, description VARCHAR(255) NOT NULL, date_ajout DATETIME NOT NULL, INDEX IDX_7CC7DA2C7ECF78B0 (cours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', available_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', delivered_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_75EA56E0FB7336F0 (queue_name), INDEX IDX_75EA56E0E3BD61CE (available_at), INDEX IDX_75EA56E016BA31DB (delivered_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE achat ADD CONSTRAINT FK_26A9845650EAE44 FOREIGN KEY (id_utilisateur) REFERENCES `user` (id)');
        ...
        $this->addSql('ALTER TABLE cours ADD CONSTRAINT FK_FDCA8C9CEB85BD39 FOREIGN KEY (nom_cours_id) REFERENCES nom_cours (id)');
        $this->addSql('ALTER TABLE cours ADD CONSTRAINT FK_FDCA8C9C86EC68D8 FOREIGN KEY (tuteur_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE nom_cours ADD CONSTRAINT FK_57321009BCF5E72D FOREIGN KEY (categorie_id) REFERENCES categorie (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE achat DROP FOREIGN KEY FK_26A9845650EAE44');
        ...
        $this->addSql('ALTER TABLE cours DROP FOREIGN KEY FK_FDCA8C9CEB85BD39');
        $this->addSql('ALTER TABLE cours DROP FOREIGN KEY FK_FDCA8C9C86EC68D8');
        $this->addSql('ALTER TABLE nom_cours DROP FOREIGN KEY FK_57321009BCF5E72D');
